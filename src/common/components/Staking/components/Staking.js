...
const Staking = ({ account }) => {
    ...
    return (
        <div>
            <h2>Staking</h2>
            <p>
                <strong>Staked: </strong> {views.staked} JUTC
            </p>
            <p>
                <strong>Reward: </strong> {views.reward} JUTC
            </p>
            <p>
                <strong>Total Staked: </strong> {views.totalStaked} JUTC
            </p>
            <div style={{ display: "flex" }}>
                <form onSubmit={handleStake}>
                    ...
                    <input
                        id="stake"
                        placeholder="0.0 JUTC"
                        value={stake}
                        onChange={e => setStake(e.target.value)}
                    />
                    <button type="submit">Stake JUTC</button>
                </form>
                <form onSubmit={handleWithdraw}>
                    ...
                    />
                    <button type="submit">Withdraw JUTC</button>
                </form>
            </div>

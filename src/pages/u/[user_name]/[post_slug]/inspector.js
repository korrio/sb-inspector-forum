...
import SinglePostEvidenceComponent from '@/modules/singlePostEvidence/components';

const SinglePostEvidence = ({ singlePost, listPostUser, listComment }) => {
	return (
		<>
			<MetaWebsite
			...
			/>
			<Layout>
				<SinglePostEvidenceComponent singlePost={singlePost} listPostUser={listPostUser} listComment={listComment} />
			</Layout>
		</>
	);
};
...
export default SinglePostEvidence;
